...
class Window(tk.Tk):
    def __init__(self):
        ...
        back_path= os.path.abspath('./../work/icons/back.png')
        print(back_path)
        img = ImageTk.PhotoImage(Image.open('./../work/icons/back.png').resize((16, 16), Image.ANTIALIAS))
        ...
        img = ImageTk.PhotoImage(Image.open('./../work/icons/forward.png').resize((16, 16), Image.ANTIALIAS))
        ...
        img = ImageTk.PhotoImage(Image.open('./../work/icons/up.png').resize((16, 16), Image.ANTIALIAS))
        ...
        img = ImageTk.PhotoImage(Image.open('./../work/icons/update.png').resize((16, 16), Image.ANTIALIAS))
        ...
        self.file_image = tk.PhotoImage(file="./../work/icons/file.png")
        self.folder_image = tk.PhotoImage(file="./../work/icons/folder.png")
